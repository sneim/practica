...
namespace App3
{
    class Program
    {
        ...
        {
            string[] input = File.ReadAllLines(@"C:\Users\gr622_nemol\Desktop\practica\ConsoleApp2\ConsoleApp3\bin\Debug\net7.0\input.txt");
            ...
            File.WriteAllLines(@"C:\Users\gr622_nemol\Desktop\practica\ConsoleApp2\ConsoleApp3\bin\Debug\net7.0\output.txt", result.ToArray());
